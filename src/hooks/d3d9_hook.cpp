...
namespace {
    ...
    using t_CreateDevice = HRESULT(WINAPI*)(
        IDirect3D9* pD3D,
	    UINT Adapter,
    ...
    HRESULT WINAPI hk_CreateDevice(
	    IDirect3D9* pD3D,
	    UINT Adapter,
	    D3DDEVTYPE DeviceType,
	    HWND hFocusWindow,
        ...
        auto createDeviceEvent = std::make_shared<Events::CreateDeviceEvent>(pD3D, Adapter, 
            DeviceType, 
            hFocusWindow, 
            BehaviorFlags, 
            pPresentationParameters, ppReturnedDeviceInterface);
        ...
        return o_CreateDevice(createDeviceEvent->pD3D, createDeviceEvent->Adapter, 
            ...
            createDeviceEvent->pPresentationParameters, createDeviceEvent->ppReturnedDeviceInterface);
    }
...
void D3D9Hook::install()
{
    ...
    HookManager::instance().addHook(
        reinterpret_cast<void**>(&o_CreateDevice),
